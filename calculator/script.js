...
window.update = function() {
  ...
  const mapping = {
    ...
    's2-inv': '~' + Math.round((parseInt(document.getElementById('sl-panels')?.value || 10) * POWER_PER_PANEL * (parseFloat(document.getElementById('sl-prix-wc')?.value || 1.1))) / 1000) + 'K€',
    's3-inv': '~' + Math.round((parseInt(document.getElementById('sl-panels')?.value || 10) * POWER_PER_PANEL * (parseFloat(document.getElementById('sl-prix-wc')?.value || 1.1)) + (parseFloat(document.getElementById('sl-prix-batt')?.value || 7000))) / 1000) + 'K€',
